...
import com.codekinian.hitzgenic.Adapter.ReviewsAdapter;
import com.codekinian.hitzgenic.Base.MvpActivity;
import com.codekinian.hitzgenic.BuildConfig;
import com.codekinian.hitzgenic.Helpers.FavoriteHelper;
...
import com.codekinian.hitzgenic.Model.GoogleDetailModel.Review;
...
import static com.codekinian.hitzgenic.Helpers.DatabaseContract.CONTENT_URI;
import static com.codekinian.hitzgenic.Helpers.FavoriteColumn.COLUMN_ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharePlace.setOnClickListener(v -> {
            ...
            String shareBody = "[Hitzgenic] \nAyo kunjungi " + list.getName()+". Aku tunggu kamu disana ya! " +
                    "http://hitzgenic.castcoding.web.id/"+list.getPlaceId();
