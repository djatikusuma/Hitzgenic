...
public class CustomClickMarker extends MapsFragment implements GoogleMap.OnInfoWindowClickListener {
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        btnDirect.setOnClickListener(view -> moveDirect(placeModel.getPlaceId()));
    ...
    public void moveDirect(String placeId){
        Intent intent = new Intent(context, DirectMapsActivity.class);
